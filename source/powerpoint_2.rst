...
| スライドを作成する際には、タイトルでそのスライドで何を伝えたいのか記述しておくと良いです。
| 「回帰分析の結果」の様なタイトルをつける方が多いですが、回帰分析の結果何が分かったのかをタイトルに書きます。
| こうしておくことで、聴衆は聞き逃しなどがあっても話についていくことが可能になります。

.. figure:: _static/images/powerpoint/title_imp.png
